...
var _ AuthContext = (*firebaseAuthContext)(nil)

func (v *firebaseAuthContext) User(ctx context.Context, authRequired bool) (User, error) {
	...
	v.userContext = user{id: v.fbAuthToken.UID}
...
func NewFirebaseAuthContext(firebaseIDToken func() (string, error)) AuthContext {
