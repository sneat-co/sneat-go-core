...
// MockRegistrationArgs is a mock of RegistrationArgs interface.
...
func (m *MockRegistrationArgs) Handle() module.HTTPHandleFunc {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Handle")
	ret0, _ := ret[0].(module.HTTPHandleFunc)
	return ret0
}
